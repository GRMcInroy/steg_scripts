...
for (i in 1:3) {    
      ...
      if (encoding == "7bit") {
            ...
            bin_codes[[i]] <- pastedGamma  ## Captures oyput of intermediates in the for loop                   
...
## "111" is unique for gamma or delta encoded elias numbers
## "000" is unique for omega coded elias numbers
